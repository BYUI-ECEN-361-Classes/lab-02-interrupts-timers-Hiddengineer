...
2. Do all LEDs toggle at *exactly* the same time? [*Yes once every second*]
...
1. What has happened to the speed of the timers? [*it got much slower*]
...
If you do any of these items - just mention what and how it worked, [*implemented min wait time*].
